...
const multiplyBy2WithLog = a =>
  [multiplyBy2(a), `${a} multiplyBy2\n`]
...
console.log('Options 1', operationsWithLog(1).toString())
...
// That is to turn Int -> Int to Int -> Writer [String] Int
const multiplyBy2WithWriter = a =>
  W
    .of(a)
    .tell([`${a} multiplyBy2`])
    .map(always(multiplyBy2(a)))
...
const operationsWithWriter = composeK(
  divideBy3WithWriter,
  add1WithWriter,
  multiplyBy2WithWriter
)

console.log('Option 2: ', operationsWithWriter(1).run())